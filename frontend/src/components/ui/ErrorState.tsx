...
export const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-[var(--surface)] border border-[var(--danger-border)] rounded-[4px] text-center max-w-md mx-auto shadow-xs">
      <div className="w-12 h-12 rounded-[4px] bg-[var(--danger-bg)] text-[var(--danger)] flex items-center justify-center mb-3">
      ...
      <p className="text-[13px] text-[var(--text-secondary)] mb-4">{message}</p>
      {onRetry && (
